...
namespace Drivers.Services.AppFileWatcherService
{
    public class AppFileWatcherService : IAppFileWatcherService
    {
        ...
        private readonly IQueueService<AppFileUpdateResponseMessag> _fileSyncQueue;
        private readonly IQueueService<AppFileSyncRequestMessage> _fileRequestSyncQueue;
        private readonly IQueueService<AppFileErrorMessage> _fileErrorQueue;
        private readonly IQueueService<AppFileStatusCheckResponseMessage> _responseQueue;
        private readonly IQueueService<AppFileUpdateRequestMessage> _updateQueue;
        private readonly IQueueService<AppFileValidateStatusResponse> _validateStatusQueue;
        ...
        {
            var response = new BaseResponse<List<FileSystemWatcher>>(true);
