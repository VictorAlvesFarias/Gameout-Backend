...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20251020162236_atumalaca")]
    partial class atumalaca
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entitites.BaseEntityIdentity", b =>
                {
            ...
            modelBuilder.Entity("Domain.Entitites.Shared.AppFileLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Domain.Entitites.ApplicationContextDb.AppFile", b =>
                {
                    b.HasOne("Domain.Entitites.BaseEntityIdentity", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Domain.Entitites.BaseEntityIdentity", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
