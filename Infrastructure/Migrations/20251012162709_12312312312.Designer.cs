...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20251012162709_12312312312")]
    partial class _12312312312
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entitites.AppStoredFile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Domain.Entitites.StoredFile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Domain.Entitites.AppStoredFile", b =>
                {
                    b.HasOne("Domain.Entitites.AppFile", "AppFile")
                        .WithMany()
                        .HasForeignKey("AppFileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.Entitites.StoredFile", "StoredFile")
                        .WithMany()
